...
_Auto-generated from curated `datasets/` on 2026-09-24T09:03:29Z. Sandbox drafts are excluded._

| Metric | Count |
| --- | ---: |
| Accessions | 9,786 |
| SDRF files | 10,011 |
| Accessions with a declared template | 9,784 |
| Samples (unique `source name` per file) | 276,823 |
| Runs (unique `comment[data file]` per file) | 374,497 |
| Assay rows | 459,587 |
| Human contributors | 26 |
| AI agents (named fingerprints) | 5 |
| AI-assisted accessions | 9,786 |
| Unidentified agent | 2,436 |
| Multi-agent accessions | 339 |
| Distinct instruments | 146 |
| Median runs per accession | 12 |
| Accessions with modification parameters | 4,263 |
| ProteomeXchange coverage | 9,739 / 56,634 (17.2%) |
| PRIDE coverage | 9,569 / 41,726 (22.9%) |

**Highlights:** most common organism is **Homo sapiens**; **81,418** DIA assay rows; **72,216** TMT and **345,675** LFQ assay rows; **68** single-cell, **467** cell-line, and **594** metaproteomics accessions; sample-field completeness (applicable samples): disease 35%, age 9%; all **9,786** accessions are AI-assisted (**26** human contributors, **5** named AI agents); identified fingerprints are mostly **Cursor**; **2,436** accessions have no vendor fingerprint (typical of Claude Code committed as the reviewer); **398** accessions have Codex evidence (`codex/` PR branches); **339** accessions were touched by more than one agent (most common handoff **Cursor → Codex**); most common instrument is **Q Exactive**; most common modification is **Carbamidomethyl**; **17.2%** of public ProteomeXchange datasets have a curated SDRF here; **22.9%** of PRIDE projects are annotated.
