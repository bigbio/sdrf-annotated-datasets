...
_Auto-generated from curated `datasets/` on 2026-09-03T13:16:02Z. Sandbox drafts are excluded._
...
| Samples (unique `source name` per file) | 226,559 |
| Runs (unique `comment[data file]` per file) | 285,335 |
| Assay rows | 359,048 |
