...
_Auto-generated from curated `datasets/` on 2026-09-25T16:17:19Z. Sandbox drafts are excluded._

| Metric | Count |
| --- | ---: |
| Accessions | 10,028 |
| SDRF files | 10,289 |
| Accessions with a declared template | 10,026 |
| Samples (unique `source name` per file) | 310,902 |
| Runs (unique `comment[data file]` per file) | 417,458 |
| Assay rows | 510,386 |
| Human contributors | 27 |
| AI agents (named fingerprints) | 5 |
| AI-assisted accessions | 10,028 |
