...
_Auto-generated from curated `datasets/` on 2026-08-28T07:46:22Z. Sandbox drafts are excluded._

| Metric | Count |
| --- | ---: |
| Accessions | 6,172 |
| SDRF files | 6,315 |
| Samples (unique `source name` per file) | 149,453 |
| Runs (unique `comment[data file]` per file) | 204,709 |
| Assay rows | 267,381 |
