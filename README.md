...
_Auto-generated from curated `datasets/` on 2026-09-04T08:21:49Z. Sandbox drafts are excluded._

| Metric | Count |
| --- | ---: |
| Accessions | 7,839 |
| SDRF files | 8,013 |
| Accessions with a declared template | 7,784 |
| Samples (unique `source name` per file) | 226,992 |
| Runs (unique `comment[data file]` per file) | 293,631 |
| Assay rows | 367,344 |
