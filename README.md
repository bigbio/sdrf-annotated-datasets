...
_Auto-generated from curated `datasets/` on 2026-09-16T07:58:55Z. Sandbox drafts are excluded._
...
| Samples (unique `source name` per file) | 246,510 |
| Runs (unique `comment[data file]` per file) | 318,402 |
| Assay rows | 399,179 |
| Human contributors | 18 |
| AI agents (named fingerprints) | 5 |
| AI-assisted accessions | 8,372 |
| Unidentified agent | 1,225 |
| Multi-agent accessions | 340 |
| Distinct instruments | 128 |
| Median runs per accession | 12 |
| Accessions with modification parameters | 2,907 |
| ProteomeXchange coverage | 8,325 / 56,387 (14.8%) |
| PRIDE coverage | 8,163 / 41,565 (19.6%) |

**Highlights:** most common organism is **Homo sapiens**; **61,290** DIA assay rows; **68,526** TMT and **293,496** LFQ assay rows; **68** single-cell, **329** cell-line, and **594** metaproteomics accessions; sample-field completeness (applicable samples): disease 31%, age 10%; all **8,372** accessions are AI-assisted (**18** human contributors, **5** named AI agents); identified fingerprints are mostly **Cursor**; **1,225** accessions have no vendor fingerprint (typical of Claude Code committed as the reviewer); **399** accessions have Codex evidence (`codex/` PR branches); **340** accessions were touched by more than one agent (most common handoff **Cursor → Codex**); most common instrument is **Q Exactive**; most common modification is **Carbamidomethyl**; **14.8%** of public ProteomeXchange datasets have a curated SDRF here; **19.6%** of PRIDE projects are annotated.
