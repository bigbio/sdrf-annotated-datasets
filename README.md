...
_Auto-generated from curated `datasets/` on 2026-08-29T12:45:14Z. Sandbox drafts are excluded._
...
| Samples (unique `source name` per file) | 159,805 |
| Runs (unique `comment[data file]` per file) | 209,180 |
| Assay rows | 281,922 |
