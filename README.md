...
_Auto-generated from curated `datasets/` on 2026-09-03T20:43:33Z. Sandbox drafts are excluded._

| Metric | Count |
| --- | ---: |
| Accessions | 7,838 |
| SDRF files | 8,012 |
| Accessions with a declared template | 7,783 |
| Samples (unique `source name` per file) | 226,946 |
| Runs (unique `comment[data file]` per file) | 293,491 |
| Assay rows | 367,204 |
