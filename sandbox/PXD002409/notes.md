...
- Free-text chemistry still mentions dimethyl-like terms that cannot be safely normalized without stronger evidence.
...
- Move back to `datasets/PXD002409/` only after the unresolved issue is fixed.
