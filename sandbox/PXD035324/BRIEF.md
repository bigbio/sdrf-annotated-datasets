...
## `PXD035324-celllines.sdrf.tsv`
- 176 `characteristics[...]` cells encoded as `NT=...;AC=...` instead of the bare ontology label
- 22 coordinate collisions (source name x biological replicate x technical replicate x fraction, no separating column)

## `PXD035324-patients.sdrf.tsv`
- 228 `characteristics[...]` cells encoded as `NT=...;AC=...` instead of the bare ontology label
