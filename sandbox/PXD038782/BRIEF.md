...
## `PXD038782.sdrf.tsv`
- 2 pandas artifact header(s) matching `]`+`.N`
- 347 coordinate collisions (source name x biological replicate x technical replicate x fraction, no separating column)
