...
## `PXD058376-immunopeptidome.sdrf.tsv`
- parse_sdrf validate-sdrf: `characteristics[sample type]` values are not in the validator's `pride` ontology list

Sibling file(s) of this accession that pass the gate are already under `datasets/PXD058376/`: `PXD058376-synthetic.sdrf.tsv`.
